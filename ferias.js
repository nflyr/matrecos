	...
	FERIADO.push(new Feriado('0001-01-01','Domingo de Páscoa'));
	...
	FERIADO.push(new Feriado('0001-08-15','Assunção de Nossa Senhora'));
	FERIADO.push(new Feriado('0001-10-05','Implantação da República'));
	FERIADO.push(new Feriado('0001-11-01','Todos os Santos'));
	FERIADO.push(new Feriado('0001-12-01','Restauração da Independência'));
	FERIADO.push(new Feriado('0001-12-08','Imaculada Conceição'));
	FERIADO.push(new Feriado('0001-12-24','Feriado Bancário'));
	...
	function getPerTypeInfo(t,obs){return ['Férias','black']}
